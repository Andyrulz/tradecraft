...
export function ScreenerResults({ stocks, loading }: ScreenerResultsProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={view === 'grid' ? 'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4' : 'space-y-3 sm:space-y-4'}>
        {stocks.map((stock) => (
          <Card key={stock.symbol} className="group border border-muted/50 hover:border-primary/50 transition-all duration-300 w-full min-h-[260px]">
