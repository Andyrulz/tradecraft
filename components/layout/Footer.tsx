				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
					...
					<div>
						...
						<ul className="space-y-2">
							<li>
								<Link
									href="/education/trading-strategies-and-concepts"
							...
							<li>
								<Link
									href="/education/case-studies-success-stories"
									className="text-sm text-muted-foreground hover:text-primary transition-colors"
								>
							...
							<li>
								<Link
									href="/education/feature-breakdowns-updates"
									className="text-sm text-muted-foreground hover:text-primary transition-colors"
								>
							...
							<li>
								<Link
									href="/education/how-to-use-tradecraft"
									className="text-sm text-muted-foreground hover:text-primary transition-colors"
								>
					...
					<div>
						...
						<p className="text-xs text-muted-foreground mt-4 text-left">
							...
							only and should not be considered financial advice. Always do your
