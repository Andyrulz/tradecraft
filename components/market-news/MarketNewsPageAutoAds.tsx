...
import { generateBreadcrumbStructuredData, generateFinancialServiceStructuredData } from '@/lib/seo';
...
export default function MarketNewsPageAutoAds() {
  ...
  const breadcrumbData = generateBreadcrumbStructuredData([
    ...
    { name: 'Stock Market News', url: 'https://www.tradingsetup.pro/news' }
  ]);

  const financialServiceData = generateFinancialServiceStructuredData();
    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 py-6 pb-8">
        ...
        <div className="hidden lg:grid lg:grid-cols-12 lg:gap-8">
          ...
          <div className="lg:col-span-8">            {/* Featured article section */}
            <section className="mb-12">
              <div className="overflow-hidden">
                <NewsCard item={featured} featured />
              </div>
