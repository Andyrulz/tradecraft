...
export async function POST(request: Request) {
  ...
  if (usage.request_count >= planLimit) {
    ...
    if (planType === 'free') {
      upgradeMessage =
        'You have used up your daily quota of 3 trade plans. Upgrade to Pro or Premium for more requests and advanced features. Even one good trade can pay for your subscription!';
      cta = 'Upgrade Now';
