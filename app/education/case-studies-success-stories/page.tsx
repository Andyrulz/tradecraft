...
export default function CaseStudies() {
  return (
    <>
      <Head>
        <title>TradeCraft Education: Case Studies & Success Stories</title>
        <meta name="description" content="Explore real-world case studies and success stories from TradeCraft users. See how traders and investors are using TradeCraft to improve their results." />
        <meta property="og:title" content="TradeCraft Education: Case Studies & Success Stories" />
        <meta property="og:description" content="Explore real-world case studies and success stories from TradeCraft users. See how traders and investors are using TradeCraft to improve their results." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.tradingsetup.pro/education/case-studies-success-stories" />
        <meta property="og:image" content="https://www.tradingsetup.pro/bull-bear.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="TradeCraft Education: Case Studies & Success Stories" />
